...
export default function AdminArtworksPage() {
  ...
  useEffect(() => {
    const verifyAdminAndFetchArtworks = async () => {
      ...
      // 2. Mapear propietarios actuales si existen
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-neutral-800 bg-neutral-950/60 text-[10px] font-mono text-neutral-400 uppercase tracking-wider">
                  ...
                  <th className="p-4">Propietario / Claim Token</th>
        ...
        {art.sku?.toUpperCase()}
                      ...
                      <td className="p-4 space-y-1">
                        {art.current_owner ? (
                          ...
                          <div className="text-[11px]">
                            ...
                            <span className="text-amber-400 font-bold select-all">{art.claim_token || 'N/A'}</span>
                          </div>
                        )}
                      </td>
                      ...
                      <td className="p-4 text-right space-x-2">
                        <Link
                          ...
                          className="px-2.5 py-1 bg-amber-500/10 border border-amber-500/30 text-amber-400 hover:bg-amber-500/20 rounded-md text-[11px] transition inline-block"
                        >
                          Editar
                        </Link>
                        <Link
