...
export const TIER_THRESHOLDS = [
  { tier: 0, name: 'Fase Inicial', name_en: 'Initial Phase', minScore: 0, multiplier: 1.0 },
  { tier: 1, name: 'Discovery Phase', name_en: 'Discovery Phase', minScore: 500, multiplier: 1.2 },
  { tier: 2, name: 'Emerging Collector', name_en: 'Emerging Collector', minScore: 2000, multiplier: 1.5 },
  { tier: 3, name: 'Curator Choice', name_en: 'Curator Choice', minScore: 5000, multiplier: 2.0 },
  { tier: 4, name: 'Masterpiece Tier', name_en: 'Masterpiece Tier', minScore: 10000, multiplier: 3.0 }
]
